      ...
      <div className="flex items-center gap-1 shrink-0">
        {(["sm", "md", "lg"] as const).map((size) => (
          <button
            ...
            className={`min-w-[44px] min-h-[44px] px-2 rounded text-sm transition-colors outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-focus)] ${
              fontSize === size
